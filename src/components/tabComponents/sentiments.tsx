...
export default function Sentiments() {
	return (
		<div className="flex flex-col w-full  bg-white rounded-md text-black p-6 gap-4 ">
			<h1 className="text-xl font-bold text-black" id="sentiments">
				Sentiment
			</h1>
			<p className="text-lg font-bold text-gray-700">Key Events</p>

			<div className="overflow-x-scroll lg:max-w-[60vw] xl:max-w-full">
				<div className="flex gap-4 flex-nowrap">
					{/* card 1 */}
					<div className="w-[456px]  p-4 flex flex-shrink-0 bg-blue-100 rounded-xl gap-x-3">
					...
					{/* card 2 */}
					<div className="w-[456px] flex-shrink-0 p-4 flex bg-green-100 rounded-xl gap-x-3">
						<div className="w-[15%] flex items-start justify-center">
