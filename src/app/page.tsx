...
export default function Home() {
	...
	// useEffect(() => {
	// 	router.push('/bitcoin'); // Replace 'your-dynamic-route' with your actual dynamic route
	//   }, []);
	...
	// 	fetchData();
	// }, []);
	// console.log("trendingData12345678234567", trendingData);
	...
	return (
		<div className=" bg-blue-400 text-center mt-20">

			plz use link as "/coinName"
