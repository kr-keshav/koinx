...
export default function Header() {
	return (
		<div className="bg-white">
			<div className="mx-auto  sm:px-8 px-6 flex justify-between">
				<img src="https://www.koinx.com/_next/static/media/Logo.5f2ad8d5.svg"></img>
				<div className="md:flex flex-grow  text-center space-x-6 place hidden ">
				...
				<div className=" text-center space-x-6 place md:hidden ml-auto place-items-center place-self-center">
					<HeaderDropDown />
				</div>
			</div>
		</div>
